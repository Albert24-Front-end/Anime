const animeDetails =()=> {
    ...
    const renderAnimeDetails = (array, itemId) => {
      ...
      if(animeObj) {
        ...
        titleBlock.textContent = animeObj.title; // заменяем текстовое содержимое
        ...
        `) // join - объединяет массивы в одну строку с добавлением знаков препинания
    ...
    fetch("./db-2.json").then((response) =>  response.json())
    .then((data)=> {
